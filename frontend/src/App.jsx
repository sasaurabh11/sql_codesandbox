      ...
      <div className="max-w-7xl mx-auto">
        <header className="flex items-center justify-between mb-8 py-4 border-b border-gray-700">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent leading-none">
                SQL Sandbox
              </h1>
              <p className="text-sm text-gray-400 mt-1 leading-none">
          ...
          <div className="flex items-center space-x-3">
            <span className="text-sm text-gray-400">Made with 💙 by</span>
            <span className="px-3 py-1 text-sm font-medium bg-gradient-to-r from-blue-600 to-purple-600 rounded-full shadow-md">
              Saurabh
            </span>
          </div>
        </header>
                    ...
                    <div className="text-sm text-gray-400">
                      {lastResult.ok ? (
                        <span className="text-green-400">
                          {lastResult.rowCount} row
                          {lastResult.rowCount !== 1 ? "s" : ""}
                        </span>
                      ) : (
